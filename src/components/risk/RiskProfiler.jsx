...
const QUIZ_QUESTIONS = [
  {
    ...
    options: [
      { text: 'Less than 1 year (Need for immediate goals/fees)', score: 10, type: 'Short Term' },
      { text: '1 to 3 years (Medium-term purchases)', score: 30, type: 'Medium Term' },
      { text: '3 to 7 years (Goal-focused: Car, Marriage, Down Payment)', score: 65, type: 'Long Term' },
  ...
  },
  {
    ...
    options: [
      { text: 'Beginner: Mostly know Bank FDs, Savings Accounts, and Gold', score: 20, type: 'Novice' },
...
export const RiskProfiler = () => {
  ...
  const handleSelectOption = (questionId, optionScore) => {
    ...
    if (currentStep < QUIZ_QUESTIONS.length - 1) {
      ...
      let allocation = [
        { name: 'Equity (Index & Flexi-Cap)', value: 60, color: '#10b981' },
        { name: 'Debt (PPF, Liquid, FD)', value: 25, color: '#3b82f6' },
        { name: 'Gold (SGB / ETF)', value: 10, color: '#f59e0b' },
        { name: 'Cash / Emergency Buffer', value: 5, color: '#64748b' },
      ];
      ...
      if (avgScore <= 40) {
        ...
        allocation = [
          { name: 'Equity (Large Cap/Index)', value: 25, color: '#10b981' },
          { name: 'Debt (PPF, EPF, Arbitrage)', value: 55, color: '#3b82f6' },
          { name: 'Gold (SGB / ETF)', value: 15, color: '#f59e0b' },
          { name: 'Cash / Liquid Buffer', value: 5, color: '#64748b' },
        ];
      } else if (avgScore >= 75) {
        ...
        allocation = [
          { name: 'Equity (Index, Mid & Flexi-Cap)', value: 75, color: '#10b981' },
          { name: 'Debt (PPF / Liquid)', value: 15, color: '#3b82f6' },
          { name: 'Gold (SGB)', value: 5, color: '#f59e0b' },
